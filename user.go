...
// handler signUp
// handler login  : check user then create and return token
// check user function for login
// scan if have user and password match item
// addUser  function for signUp
// add new usre and password item to index
import (
	"context"
	"encoding/json"
	"errors"
...
type User struct { // content structure
...
var mySigningKey = []byte("secret") // private key for create token
